...
PDC_Server_data_read_from2(uint64_t obj_id, struct pdc_region_info *region_info, void *buf, size_t unit)
{
    ...
    // PDC_Server_data_write_ouThe location string is cached, so we utilize
...
//	Ceph Cluster Initialisation
    ...
    gettimeofday(&pdc_timer_start, 0);
	  ...
	  //Write Data to Ceph Object
 	int	 batch = 0;
	const char *object_name="objectttt";
	const char name[100];
